...
const saveShipment = async (shipment) => {
    ...
    const shipmentId = (await trx.insert(newRootShipment, ["id"]).into("shipments"))[0].id;
...
const retrieveShipment = async (shipmentId) => {
    ...
    const shipmentOrganizations = await knex
        ...
        .join("organizations", "shipmentOrganizations.organizationId", "organizations.id")
...
const retrieveAllTotalWeights = async () => {
